...
export default function Hero() {
    ...
    return (
      <div className='bg-gradient-to-t from-redish to-hero min-h-screen'>
        <section className="text-white flex flex-col gap-16 md:gap-32 p-8 md:p-16 lg:p-32 relative">
          ...
          <div className="flex justify-center mt-36 md:mt-32">
            <div className="flex flex-col gap-16 md:gap-12 px-4 md:px-0">
              <h1 className="font-geist text-6xl lg:text-8xl font-semibold max-w-4xl text-center md:text-left">Crafted to <span className="bg-gradient-to-r from-redish to-white bg-clip-text text-transparent">Inspire</span></h1>
                ...
                <button onClick={() => scrollToSection('pricing')} className="cursor-pointer bg-white text-black text-md md:text-xl px-8 md:px-12 py-3 rounded-2xl shadow-lg shadown-black/20">View Our Work</button>
